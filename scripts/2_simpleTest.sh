...
for i in tests/in/*.c; do
    ...
    ./bin/$PARSER --parse tests/in/$BASENAME.c -o tests/out/$BASENAME.c# This checks if the shell running is BASH
#!/bin/bash

PARSER="print_canonical"
...
echo ""# This checks if the shell running is BASH
#!/bin/bash
...
for i in tests/in/*.c; do
    ...
    # The stderr will contain the loging info (useful for debugging)
    tests/in/$BASENAME.c | ./bin/$PARSER > tests/out/$BASENAME.c  2> tests/out/$BASENAME.stderr.txt
